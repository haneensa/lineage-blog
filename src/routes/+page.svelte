...
<style>
   /* Global styles */
  :global(pre) { background: #f5f5f5; padding: 1em; overflow-x: auto; }
  :global(.sql-columns) { display: flex; gap: 1rem; flex-wrap: wrap; }
  :global(.sql-column) { flex: 1; min-width: 300px; }
  /* Heading styles */
  .row {
    text-align: left;
  }
...
.sup-button {
  ...
  color: #1a73e8;              /* link blue (or use var(--link-color)) */
...
<main class="container-fluid">
  <h1>Row-level Lineage and Its Applications</h1>

  <div class="row ">
    <p>
    In data systems, understanding how data flows through pipelines is critical.
...
{#if showFootnote}
  <div class="alert alert-secondary mt-2" style="font-size:0.9em;">
    ...
    In relational DBMSes, objects can be tables, columns, tuples, or cells.
  </div>
{/if}

  <p>But, today’s lineage solutions track dependencies at the granularity of files, tables, and columns. 
      ...
      How do you figure out why an outlying value in your chart is so high?
  </p>
  
  <p>Fine-grained (row) provenance, also known as row-level lineage, quickly answers these questions and more [
    <a href="https://dspace.mit.edu/handle/1721.1/132280" target="_blank">1</a>, 
    <a href="http://www.vldb.org/pvldb/vol6/p553-wu.pdf" target="_blank">2</a>,
    <a href="https://www.vldb.org/conf/2004/RS22P1.PDF" target="_blank">3</a>,
    <a href="https://arxiv.org/abs/1805.02622" target="_blank">4</a>].
  ...
  <p>
  Row-level lineage lets us answer questions like “Which orders contributed to this customer’s total spend?” or 
  ...
  <p>
  Let’s start with two simple tables: <code>customer</code> and <code>orders</code>.
